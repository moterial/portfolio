            ...
            <Layout className='pt-16 mt-8'>
                ...
                <div className="grid w-full grid-cols-8 gap-16">
                    ...
                    <div className="col-span-3 relative h-max rounded-2xl border-2 border solid border-dark bg-light p-8 ">
                        <div className="absolute top-2 -right-3 -z-10 w-[102%] h-[102%] rounded-2xl bg-dark"/>
                    ...
                    <div className="col-span-2 flex flex-col item-end justify-between">
                        <div className="flex flex-col items-end justify-center">
                            ...
                            <h2 className="text-xl font-medium capitalize text-dark/75 text-right">on my Decentralized identity System Polyu Capstone Project(Find in projects page)</h2>
                        </div>
                        ...
                        <div className="flex flex-col items-end justify-center">
                            ...
                            <h2 className="text-xl font-medium capitalize text-dark/75"> of experience</h2>
                        </div>
                        ...
                        <div className="flex flex-col items-end justify-center">
                            ...
                            <h2 className="text-xl font-medium capitalize text-dark/75">Freelance Project</h2>
                        </div>
